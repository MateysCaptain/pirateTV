  	...
  	const handleGoButtonClick = async () => {
	    if (selectedItem.id) {
	      try {
			...
			// console.log(similar, response2.data.id);

			// const response3 = await axios.get(`/movie/${response2.data.id}?language=en-US&append_to_response=recommendations,similar`, {
			// 	headers: {
			// 	    accept: 'application/json',
			// 	    Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiJkYmQzOGRlNzRlYTUwZDRkNDE5Mzk0OTM0OTczYTA0MCIsInN1YiI6IjY1OWUyYzkzOGU4ZDMwMDE0YzIwMjExYyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.D0rTluAv1sY7ne6WtCShIY8TfJIsx7HQ6FajTpbXC-w'
			// 	}
            ...
            // console.log(response3, response2.data.id);
								...
								{isResultsVisible && searchResults.length >= 1 && (
		  							...
		  							>
										{searchResults.map((result) => (
										    ...
										    >
										    	<img src={`${base_url}${result?.poster_path}`} alt="piratedTV" width="100" height="109.7" />
