							...
							<div className="mt-5">
								<div className="d-flex justify-content-center align-items-center flex-wrap">
									{rSearch && Object.keys(rSearch).length > 1 && (
		        						<div className="card bg-black border" onClick={() => handleClick(rSearch)} style={{ cursor: 'pointer' }}>
										  	<img 
									...
									{showSimilar && searchResults.length >= 1 && (
									  similar.map((i, index) => (
									    <div className="card bg-black border" key={index} onClick={() => handleClick(i)} style={{ cursor: 'pointer' }}>
									        <img 
